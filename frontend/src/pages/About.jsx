...
const AnimatedNumber = ({ value }) => {
  ...
  // String se sirf number nikalne ke liye (e.g. "10K+" -> 10)
  const numericValue = parseInt(value.replace(/\D/g, ''));
  const suffix = value.replace(/[0-9]/g, ''); // "K+" ya "+" nikalne ke liye
...
const AboutPage = () => {
  ...
  const stats = [
    { label: 'Year Founded', value: '2013', color: 'from-orange-50 to-orange-100', border: 'border-orange-200', text: 'text-orange-600' },
    { label: 'Countries', value: '50+', color: 'from-blue-50 to-blue-100', border: 'border-blue-200', text: 'text-blue-600' },
    { label: 'Members', value: '10K+', color: 'from-green-50 to-green-100', border: 'border-green-200', text: 'text-green-600' },
    { label: 'Events', value: '200+', color: 'from-purple-50 to-purple-100', border: 'border-purple-200', text: 'text-purple-600' },
  ];
              ...
              <div className="grid grid-cols-2 gap-4 pt-6">
                {stats.map((stat, idx) => (
                  <motion.div
                    ...
                    className={`bg-gradient-to-br ${stat.color} p-4 rounded-xl border ${stat.border} shadow-sm hover:shadow-lg transition-shadow duration-300 group text-center cursor-default`}
                  >

                    <div className={`text-3xl font-bold ${stat.text} mb-1 transition-colors duration-300`}>
