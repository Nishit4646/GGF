...
const AnimatedNumber = ({ value }) => {
  ...
  useEffect(() => {
    // Starts from 0 to target value on mount
...
const AwardsPage = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center text-center">
      ...
      <div className="inline-flex items-center space-x-2 bg-orange-100 text-orange-800 px-5 py-2 rounded-full text-sm font-bold mb-8 border border-orange-200 shadow-sm">
      ...
      <div className="relative mb-10">
        ...
        <Trophy className="w-24 h-24 text-orange-600 relative drop-shadow-lg" />
      </div>
      ...
      <h2 className="text-2xl md:text-4xl text-gray-800 font-bold mb-8 italic tracking-wide">
        Salute India NRI Award
      </h2>

      
      <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed font-medium mb-16">
        Recognizing extraordinary achievements and humanitarian contributions of Gujaratis around the world.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full max-w-6xl">
        {[
          ...
          <div 
            key={idx} 
            className={`relative overflow-hidden bg-gradient-to-br ${stat.color} p-8 rounded-[2rem] shadow-2xl text-white flex flex-col items-center justify-center transform hover:-translate-y-2 transition-all duration-300 border-b-4 border-black/10`}
          >
  ...
  <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
  {/* Header Section: Trophy -> Badge -> Text */}
  <div className="text-center mb-16 flex flex-col items-center">
    
    {/* 1. Trophy (Sabse Upar) */}
    <div className="mb-6 relative inline-block">
      <div className="absolute inset-0 bg-orange-500/20 blur-[50px] rounded-full"></div>
      <Trophy className="w-20 h-20 text-orange-600 relative drop-shadow-md" />
    </div>

    {/* 2. Celebration Badge */}
    <div className="inline-flex items-center space-x-2 bg-orange-100 text-orange-800 px-4 py-2 rounded-full text-sm font-semibold mb-8 border border-orange-200">
      <Sparkles className="w-4 h-4 text-orange-600" />
      <span>Celebrating Excellence Since 2014</span>
    </div>

    {/* 3. Main Title (Purana Style) */}
    <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
      <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-orange-500">
        NRG Awards
      </span>
    ...
    {/* 4. Subtitle (Purana Style) */}
    <h2 className="text-2xl md:text-3xl text-gray-700 font-semibold mb-6">
      Salute India NRI Award
    </h2>

    {/* 5. Description (Purana Style) */}
    <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
      Recognizing extraordinary achievements and humanitarian contributions of Gujaratis around the world
    </p>
  </div>

  {/* 6. Stats Grid (Modern Style - Jo aapko pasand aaya) */}
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
    {[
      ...
      <div 
        key={idx} 
        className={`relative overflow-hidden bg-gradient-to-br ${stat.color} p-8 rounded-[2rem] shadow-xl text-white flex flex-col items-center justify-center transform hover:-translate-y-2 transition-all duration-300`}
      >
        {/* Decorative Background Icon */}
        <stat.icon className="absolute -right-4 -bottom-4 w-24 h-24 opacity-10 rotate-12" />
        
        <div className="bg-white/20 p-3 rounded-xl backdrop-blur-md mb-4 border border-white/20">
          <stat.icon className="w-8 h-8 text-white" />
        </div>
        ...
        <div className="text-sm font-medium opacity-90 uppercase tracking-wider text-center">
          {stat.label}
        </div>
      </div>
    ))}
